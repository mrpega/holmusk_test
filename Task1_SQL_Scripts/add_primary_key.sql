...
ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT xpk_EPISODE PRIMARY KEY (episode_id);

ALTER TABLE cdm_schema.METADATA ADD CONSTRAINT xpk_METADATA PRIMARY KEY (metadata_id);

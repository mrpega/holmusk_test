...
ALTER TABLE cdm_schema.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_admitted_from_concept_id FOREIGN KEY (admitted_from_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_discharged_to_concept_id FOREIGN KEY (discharged_to_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_admitted_from_concept_id FOREIGN KEY (admitted_from_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_discharged_to_concept_id FOREIGN KEY (discharged_to_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_parent_visit_detail_id FOREIGN KEY (parent_visit_detail_id) REFERENCES cdm_schema.VISIT_DETAIL (VISIT_DETAIL_ID);
...
ALTER TABLE cdm_schema.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_provider_id FOREIGN KEY (provider_id) REFERENCES cdm_schema.PROVIDER (PROVIDER_ID);

ALTER TABLE cdm_schema.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES cdm_schema.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);

ALTER TABLE cdm_schema.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_visit_detail_id FOREIGN KEY (visit_detail_id) REFERENCES cdm_schema.VISIT_DETAIL (VISIT_DETAIL_ID);

ALTER TABLE cdm_schema.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_procedure_source_concept_id FOREIGN KEY (procedure_source_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.DEVICE_EXPOSURE ADD CONSTRAINT fpk_DEVICE_EXPOSURE_unit_concept_id FOREIGN KEY (unit_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.DEVICE_EXPOSURE ADD CONSTRAINT fpk_DEVICE_EXPOSURE_unit_source_concept_id FOREIGN KEY (unit_source_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_unit_source_concept_id FOREIGN KEY (unit_source_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_meas_event_field_concept_id FOREIGN KEY (meas_event_field_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_obs_event_field_concept_id FOREIGN KEY (obs_event_field_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.NOTE ADD CONSTRAINT fpk_NOTE_note_event_field_concept_id FOREIGN KEY (note_event_field_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.LOCATION ADD CONSTRAINT fpk_LOCATION_country_concept_id FOREIGN KEY (country_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.PAYER_PLAN_PERIOD ADD CONSTRAINT fpk_PAYER_PLAN_PERIOD_payer_plan_period_id FOREIGN KEY (payer_plan_period_id) REFERENCES cdm_schema.PERSON (PERSON_ID);
...
ALTER TABLE cdm_schema.CONDITION_ERA ADD CONSTRAINT fpk_CONDITION_ERA_person_id FOREIGN KEY (person_id) REFERENCES cdm_schema.PERSON (PERSON_ID);
...
ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT fpk_EPISODE_person_id FOREIGN KEY (person_id) REFERENCES cdm_schema.PERSON (PERSON_ID);

ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT fpk_EPISODE_episode_concept_id FOREIGN KEY (episode_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT fpk_EPISODE_episode_object_concept_id FOREIGN KEY (episode_object_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT fpk_EPISODE_episode_type_concept_id FOREIGN KEY (episode_type_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.EPISODE ADD CONSTRAINT fpk_EPISODE_episode_source_concept_id FOREIGN KEY (episode_source_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);

ALTER TABLE cdm_schema.EPISODE_EVENT ADD CONSTRAINT fpk_EPISODE_EVENT_episode_id FOREIGN KEY (episode_id) REFERENCES cdm_schema.EPISODE (EPISODE_ID);

ALTER TABLE cdm_schema.EPISODE_EVENT ADD CONSTRAINT fpk_EPISODE_EVENT_episode_event_field_concept_id FOREIGN KEY (episode_event_field_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.CDM_SOURCE ADD CONSTRAINT fpk_CDM_SOURCE_cdm_version_concept_id FOREIGN KEY (cdm_version_concept_id) REFERENCES cdm_schema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE cdm_schema.COHORT_DEFINITION ADD CONSTRAINT fpk_COHORT_DEFINITION_cohort_definition_id FOREIGN KEY (cohort_definition_id) REFERENCES cdm_schema.COHORT (COHORT_DEFINITION_ID);
